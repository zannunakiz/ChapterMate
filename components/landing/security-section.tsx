    ...
    >
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          {/* Title — full width */}
          <h2
            className={`text-6xl md:text-7xl lg:text-[119px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
              isVisible
          ...
          >
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your agents are powerful but constrained. Enterprise-grade
              security ensures they only do what you allow.
            </p>
          </div>
        </div>
