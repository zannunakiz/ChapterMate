  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 pt-32 lg:pt-40 text-center">
        ...
        <h2
          className={`text-6xl md:text-7xl lg:text-[119px] font-display tracking-tight leading-[0.9] transition-all duration-1000 ${
        ...
        >
          Your agents connect to 100+ tools and services. They read, write, and
          act autonomously across your entire stack.
        </p>
      </div>
